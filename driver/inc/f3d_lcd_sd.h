...
#define LCD_RS_CONTROL()   GPIO_ResetBits(GPIOB, GPIO_Pin_5)
#define LCD_RS_DATA()  GPIO_SetBits(GPIOB, GPIO_Pin_5)
...
#define SD_CS_HIGH()   GPIO_SetBits(GPIOB, GPIO_Pin_4)
#define SD_CS_LOW()  GPIO_ResetBits(GPIOB, GPIO_Pin_4)
