...
void f3d_i2c1_init() {
  ...
  GPIO_PinAFConfig(GPIOB, GPIO_PinSource6, GPIO_AF_4); //ALL OUR PROBLEMS EXIST HERE
  //MISO Pin 14
...
void f3d_i2c2_init() {
  ...
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOA, ENABLE);  // Port B - SDA (7) and SCL (6)
  ...
  GPIO_PinAFConfig(GPIOA, GPIO_PinSource9, GPIO_AF_4); //ALL OUR PROBLEMS EXIST HERE
  //MISO Pin 14
